let playlist = [ {
  ...
  'audio': "assets/01 Baarish - Half Girlfriend (Ash King) 190Kbps.mp3",
  'nm'	: 'Baarish-half Girlfriend', 
}, {
  'title': 'Galliyan',
  'audio': "assets/01_-_Galliyan_-_DownloadMing.SE.mp3",
  'nm'	: 'Galliyan', 
}, {
  'title': 'Mulaqat',
  'audio': "assets/mulaqat.mp3",
  'nm'	: 'Mulaqat', 
} ];
i = 0;
n = playlist.length;
...
$( '#next, #prev' ).on( 'click', function( ) {
 ...
 var j=i+1
 if(j<n)
//console.log(playlist[ j].nm );
$( '.live' ).html( "next:"+playlist[ j].nm);
else{
	j=0;
	console.log(playlist[ j].nm );
	$( '.live' ).html( "next:"+playlist[ j].nm);
